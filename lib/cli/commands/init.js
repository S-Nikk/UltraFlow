...
async function generateAgentConfig(agent) {
  ...
  switch (agent) {
    ...
    default:
      console.log(pc.yellow(`⚠️  Unknown agent: ${agent}`));
  }
}
...
function generateClaudeCodeConfig(cwd) {
  ...
  console.log(pc.green('  ✅ Generated .claude/settings.json'));
}
...
`;
  ...
  console.log(pc.green('  ✅ Generated .opencode/config.yaml'));
}
...
`;
  ...
  console.log(pc.green('  ✅ Generated AGENTS.md'));
}
...
function generateOpenClawConfig(cwd) {
  ...
  console.log(pc.green('  ✅ Generated .openclaw/ultraflow-manifest.json'));
}
